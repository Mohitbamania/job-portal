            ...
            <div class="col">
                <nav aria-label="breadcrumb" class="breadcrumb-box mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active"> <i class="fa-solid fa-user-shield me-2"></i>Admins</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card border-0 shadow-sm mb-4 rounded-3">
                    <div class="card-body card-form">
                        ...
                        <div class="table-responsive">
                            <table id="adminTable" class="table table-modern align-middle mb-0">
                                ...
                                <tbody>
                                    @foreach($admins as $admin)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{asset('profile_image/' . $admin->image)}}"
                                            ...
                                            <td class="text-center">
                                                <div class="action-buttons d-flex justify-content-center gap-1">
                                                    <!-- Edit Admin -->
                                                    <a href="{{ route('admin.adminEdit', $admin->id) }}"
                                                        class="btn-action btn-edit" data-bs-toggle="tooltip" title="Edit Admin">
