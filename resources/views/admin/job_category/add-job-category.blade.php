    ...
    <section class="section-5 bg-light">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <form id="addJobCategory" method="POST">
                    @csrf
                    <div class="card border-0 shadow-lg rounded-4">
                        ...
                        <div
                            ...
                            <h4 class="mb-0"><i class="bi bi-plus-circle me-2"></i> Add New Job Category</h4>
                        </div>
...
@section('customJS')
    <script>
        $("#addJobCategory").submit(function (e) {
            e.preventDefault();

            let formData = new FormData(this);

            $.ajax({
                url: "{{ route('admin.jobCategoryStore') }}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
                ...
                success: function (response) {
                    ...
                    if (response.status === false) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Job Category Added!',
                            text: 'New job category has been added successfully.',
                ...
                error: function (xhr) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Server Error',
                        text: 'Something went wrong while adding the job category.',
