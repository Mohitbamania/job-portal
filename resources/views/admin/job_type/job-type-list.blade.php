            ...
            <div class="col">
                <nav aria-label="breadcrumb" class="breadcrumb-box mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active"><i class="fa-solid fa-tags me-2"></i>Job Type</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card border-0 shadow-sm rounded-3 mb-4">
                    <div class="card-body card-form">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h3 class="page-title">
                                <i class="fa-solid fa-clipboard-list fs-4"></i> Job Type
                            </h3>
                            <a href="{{ route('admin.addJobType') }}"
                        ...
                        <div class="table-responsive">
                            <table id="jobTypeTable" class="table table-modern align-middle mb-0">
                                ...
                                <tbody>
                                    @foreach($jobTypes as $type)
                                        <tr>
                                            <td class="fw-medium">{{ $type->id }}</td>
                                            <td>{{ $type->name }}</td>
                                            <td class="text-center">
                                                <div class="action-buttons d-flex justify-content-center gap-1">
                                                    <!-- Edit Job Type -->
                                                    <a href="{{ route('admin.jobTypeEdit', $type->id) }}"
                                                        class="btn-action btn-edit" data-bs-toggle="tooltip" title="Edit Type">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>

                                                    <!-- Delete Job Type -->
                                                    <button onclick="DeleteJobType({{ $type->id }})"
...
@section('customJS')
    <script>
        function DeleteJobType(id) {
            Swal.fire({
                title: 'Are you sure?',
                text: "This action will permanently delete this job type!",
                icon: 'warning',
                        ...
                        success: function (response) {
                            if (response.success) {
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Deleted!',
                                    text: 'The job type has been deleted successfully.',
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Error',
                                    text: 'Something went wrong while deleting the job type.',
