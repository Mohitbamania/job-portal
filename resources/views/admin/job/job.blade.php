            ...
            <div class="col">
                <nav aria-label="breadcrumb" class="breadcrumb-box mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active"><i class="fa-solid fa-briefcase me-2"></i>Job</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card border-0 shadow-sm rounded-3 mb-4">
                    <div class="card-body card-form">
                        ...
                        <div class="table-responsive">
                            <table id="jobTable" class="table table-modern align-middle mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="action-buttons d-flex justify-content-center gap-1">
                                                    <!-- Edit Job -->
                                                    <a href="{{ route('admin.jobEdit', $job->id) }}" class="btn-action btn-edit"
                                                        data-bs-toggle="tooltip" title="Edit Job">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>

                                                    <!-- Delete Job -->
                                                    <button onclick="DeleteJob({{ $job->id }})" class="btn-action btn-delete"
