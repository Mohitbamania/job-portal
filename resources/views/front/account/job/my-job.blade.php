                    ...
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                        ...
                        <div class="card-header border-0 bg-white py-4 px-4 shadow-sm">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="fs-4 mb-0 text-primary fw-bold d-flex align-items-center">
                                    <i class="bi bi-briefcase me-2 fs"></i>
                                    My Jobs
                                </h3>
                        ...
                        <div class="card-body p-4">
                            <div class="table-responsive">
                                <table id="myJobTable" class="table table-modern align-middle mb-0">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <small class="text-muted">
                                                        {{ $job->type->name }} • {{ $job->location }}
                                                    </small>
                                                </td>
                                                <td>{{ \Carbon\Carbon::parse($job->created_at)->format('d M, Y') }}</td>
                                                <td>
                                                    <span class="badge bg-warning-subtle text-primary fw-semibold">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                {{ $myJobs->links('pagination::bootstrap-5') }}
                            </div>
                        </div>
